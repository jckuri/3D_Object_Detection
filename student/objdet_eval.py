...
def measure_detection_performance(detections, labels, labels_valid, min_iou=0.5):
    print('RUNNING measure_detection_performance')
    ...
    for label, valid in zip(labels, labels_valid):
        ...
        if valid: # exclude all labels from statistics which are not considered valid
            ...
            for detection in detections:
                ...
                [vehicle_class, x_center, y_center, z_center, box_height, box_width, box_length, yaw] = detection
                detection_corners = tools.compute_box_corners(x_center, y_center, box_width, box_length, yaw)
                
                ## step 4 : computer the center distance between label and detection bounding-box in x, y, and z

                dist_x = box.center_x - x_center
                dist_y = box.center_y - y_center
                dist_z = box.center_z - z_center
    ...
    all_positives = np.sum(labels_valid == True)
    ...
    print('all_positives={}, true_positives={}, false_negatives={}, false_positives={}'.format(all_positives, true_positives, false_negatives, false_positives))
