...
def detect_objects(input_bev_maps, model, configs):
        ...
        if 'darknet' in configs.arch:
            ...
            for sample_i in range(len(output_post)):
                ...
                for obj in detection:
                    ...
                    detections.append([vehicle_class, x, y, 0.0, 1.50, w, l, yaw])    
            ...
            detections = detections[0][vehicle_class]
    ...
    if len(detections) > 0:
        ...
        for detection in detections:
            ...
            score, x, y, z, box_height, box_width, box_length, yaw = detection
